    ...
    <div className="bg-gray-800 border border-gray-700 rounded-xl p-6 shadow-xl">
      ...
      {exams.length === 0 ? (
        ...
        <div className="space-y-3">
          {exams.map((exam) => (
            <div key={exam.id} className="p-4 bg-gray-700/50 rounded-lg border-l-4 border-blue-500 hover:bg-gray-700 transition-all">
              ...
              <div className="mt-2 text-xs font-mono text-gray-500">
                Access Code: <span className="text-green-400">{exam.accessCode}</span>
              </div>
            </div>
          ))}
        </div>
